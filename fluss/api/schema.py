...
class GraphNodeInput(BaseModel):
    ...
    voids: Annotated[tuple[ArgPortInput, ...] | None, GraphQLDefault('[]')] = None
    'Default: []'
...
class FlussChoiceAssignWidget(BaseModel):
    ...
    kind: AssignWidgetKind
    follow_value: str | None = Field(default=None, alias='followValue')
    placeholder: str | None = Field(default=None)
    model_config = ConfigDict(frozen=True)
...
class FlussArgPortChoices(BaseModel):
    """No documentation"""
...
class FlussArgPort(BaseModel):
    ...
    choices: tuple[FlussArgPortChoices, ...] | None = Field(default=None)
...
class FlussReturnPortChoices(BaseModel):
    """No documentation"""
    typename: Literal['Choice'] = Field(alias='__typename', default='Choice', exclude=True)
    value: Any
    label: str
...
class FlussReturnPort(BaseModel):
    ...
    choices: tuple[FlussReturnPortChoices, ...] | None = Field(default=None)
    model_config = ConfigDict(frozen=True)
...
Each method hands its operation to ``execute``, ``aexecute``, ``subscribe``, ``asubscribe`` of ``self``, which the class this one is mixed into (or a base of it) provides."""
    ...
    async def aupdate_workspace(self, workspace: IDCoercible, graph: GraphInput, title: str | None | UnsetType=UNSET, description: str | None | UnsetType=UNSET) -> Workspace:
        """UpdateWorkspace 
...
"""
        ...
        return (await self.aexecute(UpdateWorkspaceMutation, variables)).update_workspace

    def update_workspace(self, workspace: IDCoercible, graph: GraphInput, title: str | None | UnsetType=UNSET, description: str | None | UnsetType=UNSET) -> Workspace:
        """UpdateWorkspace 
...
"""
        ...
        if description is not UNSET:
            _input['description'] = description
        variables['input'] = _input
        return self.execute(UpdateWorkspaceMutation, variables).update_workspace

    async def acreate_workspace(self, vanilla: bool, graph: GraphInput | None | UnsetType=UNSET, title: str | None | UnsetType=UNSET, description: str | None | UnsetType=UNSET) -> Workspace:
        """CreateWorkspace 
...
"""
        ...
        variables['input'] = _input
        return (await self.aexecute(CreateWorkspaceMutation, variables)).create_workspace

    def create_workspace(self, vanilla: bool, graph: GraphInput | None | UnsetType=UNSET, title: str | None | UnsetType=UNSET, description: str | None | UnsetType=UNSET) -> Workspace:
        """CreateWorkspace 
...
"""
        ...
        variables['input'] = _input
        return (await self.aexecute(CreateRunMutation, variables)).create_run

    def create_run(self, flow: IDCoercible, snapshot_interval: int, task_id: IDCoercible) -> CreateRunMutationCreateRun:
        """CreateRun 
 Start a run on fluss
...
"""
        ...
        _input['taskId'] = task_id
        variables['input'] = _input
        return self.execute(CreateRunMutation, variables).create_run

    async def aclose_run(self, run: IDCoercible) -> CloseRunMutationCloseRun:
        """CloseRun 
 Start a run on fluss
...
"""
        variables: dict[str, builtins.object] = {}
        variables['run'] = run
        return (await self.aexecute(CloseRunMutation, variables)).close_run

    def close_run(self, run: IDCoercible) -> CloseRunMutationCloseRun:
        """CloseRun 
 Start a run on fluss
...
"""
        variables: dict[str, builtins.object] = {}
        variables['run'] = run
        return self.execute(CloseRunMutation, variables).close_run

    async def asnapshot(self, run: IDCoercible, events: Iterable[IDCoercible], t: int) -> SnapshotMutationSnapshot:
        """Snapshot 
 Snapshot the current state on the fluss platform
...
"""
        ...
        _input['t'] = t
        variables['input'] = _input
        return (await self.aexecute(SnapshotMutation, variables)).snapshot

    def snapshot(self, run: IDCoercible, events: Iterable[IDCoercible], t: int) -> SnapshotMutationSnapshot:
        """Snapshot 
 Snapshot the current state on the fluss platform
...
"""
        ...
        _input['t'] = t
        variables['input'] = _input
        return self.execute(SnapshotMutation, variables).snapshot

    async def atrack(self, reference: str, t: int, kind: RunEventKind, run: IDCoercible, caused_by: Iterable[IDCoercible], value: EventValue | None | UnsetType=UNSET, message: str | None | UnsetType=UNSET, exception: str | None | UnsetType=UNSET, source: str | None | UnsetType=UNSET, handle: str | None | UnsetType=UNSET) -> TrackMutationTrack:
        """Track 
 Track a new event on the fluss platform
...
"""
        ...
        variables['input'] = _input
        return (await self.aexecute(TrackMutation, variables)).track

    def track(self, reference: str, t: int, kind: RunEventKind, run: IDCoercible, caused_by: Iterable[IDCoercible], value: EventValue | None | UnsetType=UNSET, message: str | None | UnsetType=UNSET, exception: str | None | UnsetType=UNSET, source: str | None | UnsetType=UNSET, handle: str | None | UnsetType=UNSET) -> TrackMutationTrack:
        """Track 
 Track a new event on the fluss platform
...
"""
        ...
        if handle is not UNSET:
            _input['handle'] = handle
        variables['input'] = _input
        return self.execute(TrackMutation, variables).track

    async def aget_flow(self, id: IDCoercible) -> Flow:
        """GetFlow 
...
"""
        variables: dict[str, builtins.object] = {}
        variables['id'] = id
        return (await self.aexecute(GetFlowQuery, variables)).flow

    def get_flow(self, id: IDCoercible) -> Flow:
        """GetFlow 
...
"""
        variables: dict[str, builtins.object] = {}
        variables['id'] = id
        return self.execute(GetFlowQuery, variables).flow

    async def aflows(self, limit: int | None | UnsetType=UNSET) -> tuple[ListFlow, ...]:
        """Flows 
...
"""
        ...
        return (await self.aexecute(FlowsQuery, variables)).flows

    def flows(self, limit: int | None | UnsetType=UNSET) -> tuple[ListFlow, ...]:
        """Flows 
...
"""
        ...
        if limit is not UNSET:
            variables['limit'] = limit
        return self.execute(FlowsQuery, variables).flows

    async def asearch_flows(self, search: str | None | UnsetType=UNSET, values: list[IDCoercible] | None | UnsetType=UNSET) -> tuple[SearchFlowsQueryOptions, ...]:
        """SearchFlows 
...
"""
        ...
        return (await self.aexecute(SearchFlowsQuery, variables)).options

    def search_flows(self, search: str | None | UnsetType=UNSET, values: list[IDCoercible] | None | UnsetType=UNSET) -> tuple[SearchFlowsQueryOptions, ...]:
        """SearchFlows 
...
"""
        ...
        return (await self.aexecute(ReactiveTemplatesQuery, variables)).reactive_templates

    def reactive_templates(self, pagination: OffsetPaginationInput | None | UnsetType=UNSET) -> tuple[ReactiveTemplate, ...]:
        """ReactiveTemplates 
...
"""
        ...
        if pagination is not UNSET:
            variables['pagination'] = pagination
        return self.execute(ReactiveTemplatesQuery, variables).reactive_templates

    async def areactive_template(self, id: IDCoercible) -> ReactiveTemplate:
        """ReactiveTemplate 
...
"""
        variables: dict[str, builtins.object] = {}
        variables['id'] = id
        return (await self.aexecute(ReactiveTemplateQuery, variables)).reactive_template

    def reactive_template(self, id: IDCoercible) -> ReactiveTemplate:
        """ReactiveTemplate 
...
"""
        variables: dict[str, builtins.object] = {}
        variables['id'] = id
        return self.execute(ReactiveTemplateQuery, variables).reactive_template

    async def arun(self, id: IDCoercible) -> Run:
        """Run 
...
"""
        variables: dict[str, builtins.object] = {}
        variables['id'] = id
        return (await self.aexecute(RunQuery, variables)).run

    def run(self, id: IDCoercible) -> Run:
        """Run 
...
"""
        variables: dict[str, builtins.object] = {}
        variables['id'] = id
        return self.execute(RunQuery, variables).run

    async def asearch_runs(self, search: str | None | UnsetType=UNSET, values: list[IDCoercible] | None | UnsetType=UNSET) -> tuple[SearchRunsQueryOptions, ...]:
        """SearchRuns 
...
"""
        ...
        if values is not UNSET:
            variables['values'] = values
        return (await self.aexecute(SearchRunsQuery, variables)).options

    def search_runs(self, search: str | None | UnsetType=UNSET, values: list[IDCoercible] | None | UnsetType=UNSET) -> tuple[SearchRunsQueryOptions, ...]:
        """SearchRuns 
...
"""
        ...
        if values is not UNSET:
            variables['values'] = values
        return self.execute(SearchRunsQuery, variables).options

    async def aworkspace(self, id: IDCoercible) -> Workspace:
        """Workspace 
...
"""
        variables: dict[str, builtins.object] = {}
        variables['id'] = id
        return (await self.aexecute(WorkspaceQuery, variables)).workspace

    def workspace(self, id: IDCoercible) -> Workspace:
        """Workspace 
...
"""
        variables: dict[str, builtins.object] = {}
        variables['id'] = id
        return self.execute(WorkspaceQuery, variables).workspace

    async def aworkspaces(self, pagination: OffsetPaginationInput | None | UnsetType=UNSET) -> tuple[ListWorkspace, ...]:
        """Workspaces 
...
"""
        ...
        if pagination is not UNSET:
            variables['pagination'] = pagination
        return (await self.aexecute(WorkspacesQuery, variables)).workspaces

    def workspaces(self, pagination: OffsetPaginationInput | None | UnsetType=UNSET) -> tuple[ListWorkspace, ...]:
        """Workspaces 
...
"""
        ...
        if pagination is not UNSET:
            variables['pagination'] = pagination
        return self.execute(WorkspacesQuery, variables).workspaces
