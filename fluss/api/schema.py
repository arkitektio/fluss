...
class GraphNodeInput(BaseModel):
    ...
    'Default: []'
    constants_map: Annotated[dict | None, GraphQLDefault('{}')] = Field(validation_alias=AliasChoices('constants_map', 'constantsMap'), serialization_alias='constantsMap', default=None)
    'Default: {}'
    globals_map: Annotated[dict | None, GraphQLDefault('{}')] = Field(validation_alias=AliasChoices('globals_map', 'globalsMap'), serialization_alias='globalsMap', default=None)
    'Default: {}'
    description: str | None = None
    title: str | None = None
